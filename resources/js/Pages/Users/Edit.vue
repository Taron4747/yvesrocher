  ...
  <div>
    ...
    <div class="flex justify-start mb-8 max-w-3xl">
      <h1 class="text-3xl font-bold">
        <Link class="text-indigo-400 hover:text-indigo-600" href="/admin/users">Пользователь</Link>
    ...
    <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="update">
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          ...
          <select-input v-model="form.owner" :error="form.errors.owner" class="pb-8 pr-6 w-full lg:w-1/2" label="Админ">
        ...
        <div class="flex items-center px-8 py-4 bg-gray-50 border-t border-gray-100">
          ...
          <loading-button :loading="form.processing" class="btn-indigo ml-auto" type="submit">Редактировать Пользователя </loading-button>
        </div>
      </form>
    </div>
  </div>
